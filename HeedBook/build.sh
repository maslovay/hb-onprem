...
docker build -t heedbookregistry.azurecr.io/heedbookdev/dialoguestatusschecduler:latest -f DialogueStatusCheckerScheduler.Dockerfile . &&
...
docker push heedbookregistry.azurecr.io/heedbookdev/dialoguestatusschecduler:latest 