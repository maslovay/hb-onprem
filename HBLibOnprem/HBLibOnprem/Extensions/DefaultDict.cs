...
// https://simpleprogrammer.com/2011/08/14/making-switch-refactorings-better-defaultable-dictionary/
...
namespace HBLib.Extensions {
    public class DefaultDict<TKey, TValue> : IDictionary<TKey, TValue> {
        ...
        public DefaultDict(IDictionary<TKey, TValue> dictionary, TValue defaultValue) {
    ...
    public static class DefaultableDictionaryExtensions {
        public static IDictionary<TKey, TValue> WithDefaultValue<TValue, TKey>(this IDictionary<TKey, TValue> dictionary, TValue defaultValue) {
            return new DefaultDict<TKey, TValue>(dictionary, defaultValue);
        }
    }
}