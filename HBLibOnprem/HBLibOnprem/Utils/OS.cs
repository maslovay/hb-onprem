...
namespace HBLib.Utils {
    public class OS {
            ...
            try {
                ...
                if (!isDir) {
                    ...
                    while (isLocked) {
                        ...
                        if ((DateTime.Now - dt0).TotalSeconds > timeout) {
                            return false;
                        }
                    }
                    try {
        ...
        public static string[] GetFiles(string dir, string pattern, SearchOption searchOption = SearchOption.TopDirectoryOnly) {
