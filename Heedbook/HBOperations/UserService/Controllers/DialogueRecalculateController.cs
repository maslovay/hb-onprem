...
namespace UserService.Controllers
{
    ...
    public class DialogueRecalculateController : Controller
    {
        ...
        public DialogueRecalculateController(INotificationHandler handler, RecordsContext context, ElasticClient log, SftpClient sftpClient, INotificationPublisher notificationPublisher)
        {
            _handler = handler;
            _context = context;
            _log = log;
