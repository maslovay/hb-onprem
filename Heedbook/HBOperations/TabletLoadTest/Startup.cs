...
namespace TabletLoadTest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<TabletLoad>();
            services.AddTransient<TabletLoadRunHandler>();
            services.AddTransient<RequestJob>();
            services.AddSingleton<IJobFactory, RequestJobFactory>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IScheduler scheduler)
        {
            ...
            publisher.Subscribe<TabletLoadRun, TabletLoadRunHandler>();
