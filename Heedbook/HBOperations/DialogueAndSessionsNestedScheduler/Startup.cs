using DialogueAndSessionsNested.Extensions;
...
namespace DialogueMarkUp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var schedulerSettings = new DialogueAndSessionsNestedSettings()
            {
                Period = Configuration.GetSection(nameof(DialogueAndSessionsNested)).GetValue<int>("Period")
            };
