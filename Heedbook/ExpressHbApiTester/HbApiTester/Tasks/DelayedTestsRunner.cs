...
namespace HbApiTester.Tasks
{
    ...
    {
        public DelayedTestsRunner(HbApiTesterSettings settings, IConfiguration configuration, NLog.ILogger logger, Checker checker, IServiceProvider serviceProvider) : 
